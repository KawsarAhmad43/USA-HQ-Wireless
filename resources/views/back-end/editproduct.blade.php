...
<section class="content">
  ...
  <!-- form start -->
  <form class="form-horizontal" method="POST" action="{{ url('admin/product/update/'.$product->id) }}" accept-charset="utf-8" enctype="multipart/form-data">
    @csrf
    @method('put')
      <div class="row">
        <div class="col-md-9">
                ...
                <!-- /.card-header -->
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $product->title }}" required placeholder="Enter product name">
                        @error('name')
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('pcode') is-invalid @enderror" id="pcode" name="pcode" value="{{ $product->pcode }}" placeholder="Enter product code">
                        @error('pcode')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ $product->phone }}" placeholder="Enter phone number(s) separated by commas(,)">
                        @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('bkash') is-invalid @enderror" id="bkash" name="bkash" value="{{ $product->bkash }}" placeholder="Enter bkash Marchent number">
                        @error('bkash')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-offset-2 col-sm-9">
                        <div class="form-check">
                          <input type="checkbox" name="hot" class="form-check-input" id="hot" @if( $hotdeal ) checked @endif>
                    ...
                    <div class="form-group row">
                      <div class="col-md-3" style="padding:0;">
                          <div class="border imgDiv">
                                  <img src="@if($product->img1) {{ asset('/') }}image/product_image/{{ $product->img1 }} @else {{ asset('/') }}image/product_img.png @endif" id="img1" class="images">
                                  <input type="file" name="img1" id="valueImg1" class="upload" onchange="readURL1(this);">
                                  <input type="hidden" value="{{ $product->img1 }}" name="preimg1" />
                          </div>
                      ...
                      <div class="col-md-3" style="padding:0;">
                          <div class="border imgDiv">
                                  <img src="@if($product->img2) {{ asset('/') }}image/product_image/{{ $product->img2 }} @else {{ asset('/') }}image/product_img.png @endif" id="img2" class="images">
                                  <input type="file" name="img2" id="valueImg2" class="upload" onchange="readURL2(this);">
                                  <input type="hidden" value="{{ $product->img2 }}" name="preimg2" />
                          </div>
                          <input type="button" style="float:left;margin-left:5px;width: 140px;" class="btn btn-sm btn-info" value="Add">
                      ...
                      <div class="col-md-3" style="padding:0;">
                          <div class="border imgDiv">
                                  <img src="@if($product->img3) {{ asset('/') }}image/product_image/{{ $product->img3 }} @else {{ asset('/') }}image/product_img.png @endif" id="img3" class="images">
                                  <input type="file" name="img3" id="valueImg3" class="upload" onchange="readURL3(this);">
                                  <input type="hidden" value="{{ $product->img3 }}" name="preimg3" />
                          </div>
                          <input type="button" style="float:left;margin-left:5px;width: 140px;" class="btn btn-sm btn-info" value="Add">
                      ...
                      <div class="col-md-3" style="padding:0;">
                          <div class="border imgDiv">
                                  <img src="@if($product->img4) {{ asset('/') }}image/product_image/{{ $product->img4 }} @else {{ asset('/') }}image/product_img.png @endif" id="img4" class="images">
                                  <input type="file" name="img4" id="valueImg4" class="upload" onchange="readURL4(this);">
                                  <input type="hidden" value="{{ $product->img4 }}" name="preimg4" />
                          </div>
                          <input type="button" style="float:left;margin-left:5px;width: 140px;" class="btn btn-sm btn-info" value="Add">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                          <textarea id="long_description" name="long_description" placeholder="Place some text here" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;">{{ $product->long_description }}</textarea>
                      </div>
                    </div>
                    <textarea id="des" style="display:none;">{{ $product->long_description }}</textarea>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="rprice" name="rprice" value="{{ $product->rprice }}" placeholder="Regular Price">
                      </div>
                      <div class="form-group">
                        <label for="sprice">Standard Price <span style="color:red;">*</span></label>
                        <input type="number" class="form-control" id="sprice" name="sprice" value="{{ $product->sprice }}" placeholder="Standard Price">
                      </div>
                  </div>
                  <!-- /.card-body -->
              </div>
                                ...
                                <div class="form-group mb-0">
                                  <div class="form-check">
                                    <label class="form-check-label" style="display: block;">
                                        <input class="ctgs form-check-input" name="pr_ctg[]" value="{{ $category->id }}" type="checkbox" @if(in_array($category->id,$ctgs)) checked @endif >
                                        {{ $category->name }}
                                    </label>
                                  </div>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="form-group ml-4 mb-0">
                                        <div class="form-check">
                                          <label class="form-check-label" style="display: block;">
                                              <input class="ctgs form-check-input" name="pr_ctg[]" value="{{ $subctg->id }}" type="checkbox" @if(in_array($subctg->id,$ctgs)) checked @endif >
                                              {{ $subctg->name }}
                                          </label>
                                        </div>
                                      </div>
