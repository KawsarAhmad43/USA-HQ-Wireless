              ...
              <thead>
                ...
                <tbody id="CustomerOrderData">
                        ...
                        <tr>
                            ...
                            <td style="padding:10px !important;text-align:left;font-size:16px;font-weight:bold"> @if($order_details->customer_area == 1) Inside Los Angeles @else Outside Los Angeles @endif </td>
                        </tr>
                        <tr>
