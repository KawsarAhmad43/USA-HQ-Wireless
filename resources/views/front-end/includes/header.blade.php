            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="padding:0;color:red">
                <nav id="menu">
                    ...
                    <ul class="main-menu clearfix">
                        <li><a href="{{ url('/') }}" style="background:#148AD2;color:white;">Home</a></li>
                        @php
                        ...
                        <li><a style="border-right:1px solid #fff;background:#148AD2;color:white;" href="{{ url('category') }}/{{ $menu->name }}/{{ $menu->id }}" @if($i==$totalmenu)
                                 @endif  >{{ $menu->name }}
                                <?php
                            ...
                            <ul class="sub-menu" style="background-color:white;border:1px;border-style: solid;border-color: #D4D4D8;">
                                ...
                                <li><a
                                        href="{{ url('category') }}/{{ $submenu->name }}/{{ $submenu->id }}" style="background:#148AD2;color:white;">{{ $submenu->name }}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
                        ...
                        <form action="/search" method="post" class="form" role="search">
                            ...
                            <div class="form-group">
                                <div class="input-group"
                                    style="border: 2px solid #148AD2!important; border-radius: 4px;">
                    ...
                    <ul class="navbar-nav  ">
                        ...
                        <li data-toggle="modal" data-target="#mySms" class="top-menu-padding"
                            style="padding-top: 20px;padding-left: 0"><a
                                style="background:#148AD2;color: #fff;font-weight: bold;padding-left: 10px;padding-right: 10px;border-radius: 6px;"
                                href="#" title="Track Your Order" class="font-color1">
                                Order Tracking
                            </a></li>

                        <li class="top-menu-padding" style="padding-top: 20px;">
                            <a style="background:#148AD2;color: #fff;font-weight: bold;padding-left: 10px;padding-right: 10px;border-radius: 6px;"
        ...
        <form action="{{ url('order/track') }}" method="post">
            ...
            <div class="modal-content" style="border: 3px solid green;">
                ...
                <div class="modal-footer" style="border:0;padding: 50px 30px 30px 30px;">
                    <input style="color:#fff;font-weight:bold;padding: 5px;width:100% !important;background:#148AD2"
...
<nav id="menuBar" class="navbar navbar-default   " role="navigation"
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"
                style="padding-right: 0;float: left;margin-left: 20px;margin-top: 5px;background-color: #148AD2; border: 0;box-shadow: none;">
                <span class="sr-only">Toggle navigation</span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
            ...
            <a href="{{ url('/cart') }}" style="padding-top:5px; float: right;padding-right: 30px;">
                <span class="badge" style="position: absolute;background: red;color: #fff;top: 2px;right: 13px;"
                    id="MtotalCartItems">{{ Cart::content()->count() }}</span>
                <img class="img-responsive" src="{{ asset('/') }}image/manufacturer_logo/cart-icon.png"
                    alt="{{$basic->name}}"  style="padding-top: 2px;height:40px; width:40px; background: #148AD2;">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="search" id="msearchpro" class="form-control" placeholder="Search Product"
                                style="border-radius: 4px 0 0 4px !important;border-color: #148AD2;margin-left: 8px;padding-left: 10px">

                            <span style="color: #fff; background:#148AD2; border: 1px;" class="input-group-addon">
